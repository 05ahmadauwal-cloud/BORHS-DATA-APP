...
export const paymentAPI = {
  ...
  getPaystackDedicatedAccount: () => api.get('/payment/paystack/dedicated-account'),
  createPaystackDedicatedAccount: (data) => api.post('/payment/paystack/dedicated-account', data),
  getPaystackBanks: () => api.get('/payment/paystack/banks'),
