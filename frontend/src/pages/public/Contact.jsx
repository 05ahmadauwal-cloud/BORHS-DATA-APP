...
export default function Contact() {
  ...
  const phoneDigits = String(config.supportPhone || '+234 706 589 6598').replace(/\D/g, '').replace(/^0/, '234');
  const displayPhone = config.supportPhone || '+234 706 589 6598';
  const supportEmail = config.supportEmail || '05ahmadauwal@gmail.com';
